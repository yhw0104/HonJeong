...
/**
 * 개발용 Mock OAuth 검증기 — 외부 호출 없이 idToken으로 결정론적 신원을 만든다.
 *
 * <p>사용처: AuthService(oauthLogin) — OAuthVerifier 구현체로 주입된다.
 *
 * <p>실제 카카오/애플 서버에 검증 요청을 보내지 않고, 받은 idToken을 그대로 이용해
