...
/**
 * 표시용 닉네임을 만든다 — 탈퇴로 닉네임이 사라진 사용자를 '알 수 없음'으로 보여준다.
 *
 * <p>사용처: PlaceReviewResponse·ConversationService·MealRequestListItemResponse·NotificationResponse.
 *
...
public final class DisplayNames {
    ...
    /**
     * 닉네임이 비어 있으면 '알 수 없음'으로 바꾼다.
     *
     * @param nickname 원본 닉네임(null 허용)
     * @return 표시용 닉네임
     */
