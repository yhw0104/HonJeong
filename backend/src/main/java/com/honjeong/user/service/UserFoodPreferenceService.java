...
/**
 * 회원 선호 음식(최대 3개)의 upsert·조회 서비스.
 *
 * <p>사용처: 컨트롤러가 직접 쓰지 않고 AuthService(가입 complete)·UserService(프로필 수정)가 공유한다.
 *
 * <p>음식↔컬럼 변환은 엔티티가 맡고, 여기서는 "사용자당 1행" upsert 의미론만 책임진다.
 */
@Service
